...
#time.sleep(3)
ICD = driver.find_element_by_xpath('//*[@id="content"]/data/div[2]/ui-view/div/div[2]/fieldset/ng-form/table/tbody/tr[4]/td[2]/input').send_keys('sample entry')
#time.sleep(3)
title = driver.find_element_by_xpath('//*[@id="content"]/data/div[2]/ui-view/div/div[2]/fieldset/ng-form/table/tbody/tr[5]/td[2]/input').send_keys('Chest drain')
#time.sleep(3)
...
des = driver.find_element_by_xpath('//*[@id="content"]/data/div[2]/ui-view/div/div[2]/fieldset/ng-form/table/tbody/tr[2]/td[2]/textarea').send_keys('Sample Description')
time.sleep(3)
ad = driver.find_element_by_xpath('/html/body/div[10]/button').click()
btnsave = driver.find_element_by_xpath('//*[@id="titleNoteBar"]/tbody/tr/td/div/button[3]').click()
time.sleep(3)
