...
browsebtn = driver.find_element_by_css_selector('body > div.modal.fade.ng-isolate-scope.patient-records-upload.in > div > div > div > div > div.container > div > div > button').send_keys("C://Users/HP/Pictures/Borders/border.jpg")
time.sleep(5)
